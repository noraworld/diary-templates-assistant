...
| --- | --- | :---: | :---: | :---: | :---: | :---: | :---: |
| ナッツやバナナなどの軽食を摂る |  | 9 | 9 |  |  |  |  |
| アンガーログや筆記開示でぶちまける |  | 10 | 4 |  |  |  |  |
| テンションが上がる音楽を聴く |  | 10 | 5 |  |  |  |  |
| コーピングを追加する |  | 10 | 7 |  |  |  |  |
| 「コーピング・レパートリーを使うチャンスだ！」と思う |  | 10 | 10 |  |  |  |  |
| これだけたくさんのコーピングを持っているんだと認識する |  | 10 | 8 |  |  |  |  |
| YouTube を観る |  | 10 | 5 |  |  |  |  |
| 好きな YouTuber や実況者の新着動画を Google で検索する |  | 10 | 10 |  |  |  |  |
| アニメを観る |  | 9 | 5 |  |  |  |  |
| 鏡の前で変顔をする |  | 10 | 8 |  |  |  |  |
| サフランを飲む |  | 8 | 5 |  |  |  |  |
| 読書をする |  | 9 | 8 |  |  |  |  |
...
これを記入するには実際に直面したストレスに対してその行動を取った結果どのくらい効果があったのかを振り返る必要があります。
...
### 効果の高さ
その行動を実践するとストレス解消にどのくらい効果があるのかを 10 点満点で記入します。
