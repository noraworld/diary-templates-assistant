...
```
<!-- chatgpt
これは今日のオンライン英会話のレッスンで話したいことです。書かれている日本語に対する自然な英語をまとめてください。
次のルールに従って回答してください。
...
```
<!-- chatgpt
これはオンライン英会話レッスンのトランスクリプト（文字起こし）と、レッスン中に先生からチャットで教えてもらった内容をまとめたものです。
トランスクリプトに関しては会話の内容を要約して箇条書きでまとめ、チャットに関しては日本語の意味や例文などをまとめてください。
どちらも日本語でまとめてください。
...
また、チャットに関しては以下のルールに従って回答してください。
1. イギリス英語ではなくアメリカ英語でまとめてください。
...
6. 発音記号（アメリカアクセント、IPA 記号）に関してはマークダウンのインラインブロック表示にするためにバッククォートで囲んでください。
...
トランスクリプトに関しては会話の内容を日本語で要約して箇条書きでまとめ、英単語やフレーズに関しては日本語の意味や例文などをまとめてください。
どちらも日本語でまとめてください。
...
5. 発音記号（アメリカアクセント、IPA 記号）に関してはマークダウンのインラインブロック表示にするためにバッククォートで囲んでください。
